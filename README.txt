...
If not then cd to "src" folder and type: 

      > make clean

and then (requires gcc compilers to be installed on your machine): 
    
      > make

This should create an "ishocks" executable in the folder one up from
src. To run please go to the folder above src and type:
